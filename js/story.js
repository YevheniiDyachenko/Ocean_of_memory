...
const STORY_STEPS = {
  ...
  ai_analysis_cold: { // ВИСОКИЙ DISTORTION - "ЕМОЦІЙНА РЕАКЦІЯ"
    id: 'ai_analysis_cold',
    type: 'line',
    speaker: 'СИСТЕМА',
  ...
  ai_analysis_doubt: { // НИЗЬКИЙ DISTORTION - "РАЦІОНАЛЬНА ПЕРЕВІРКА"
  ...
  choice_contact: {
    ...
    type: 'choice',
    choices: [
      { label: 'Як ти вижив?', distortionDelta: +2, next: 'kai_deflect_1',tooltip: 'Ви вирішили повірити без доказів' },
      { label: 'Чому ти не відповідав так довго?', distortionDelta: -1, next: 'kai_guilt_1',tooltip: 'Ви ставите під сумнів і шукаєте логічні невідповідності' }
    ]
  },
  ...
  el_thoughts_promise: {
    ...
    type: 'line',
    speaker: null,
    text: "Я ніколи не давала такої обіцянки.\nНачебто... \nТа я весь час думала про те, що я його залишила. \nЩо могла щось зробити. \nАле що? \nВін сказав те, \nпро що я не змогла зізнатися сама собі. \nЯкби я могла повернутися, \nя б зробила все можливе, \nщоб не втратити його... \nАле ж він тут! \nКаю!",
    next: 'el_chat_4'
  },
  ...
  kai_intimate_details: {
    ...
    type: 'line',
    speaker: 'Кай',
    text: "Того ранку... \nТи зробила каву з корицею і розлила її. \nМи сміялися, а ти витирала її рукавом свого халата.\nА перед тим, як я пішов, ти провела пальцем по подряпині на шоломі і сказала: \n'Це наш таємний знак. Щоб не заблукав'.\nТакі дрібниці... Олесю. \nВони не входять до звітів. \nЇх не можна скасувати або продублювати. \nВони роблять мене тим, хто я є для тебе.",
    ambient: 'ocean_echo',
    next: 'ai_warning_1'
  },
  ...
  el_internal_2: {
    ...
    type: 'line',
    speaker: null,
    text: "Нуль відсотків кисню.  \n125 днів тому. Факт. \nАле ось він.  \nЗнає про каву. \nЗнає 'наш таємний знак'.",
  ...
  el_emotional_response: {
    ...
    type: 'line',
    speaker: null,
    text: "Ігнорувати? \nЛегко сказати.\nАле як ігнорувати щось, \nщо знає твої таємниці? \nЙого голос реальний.\nЙого слова — ті самі.\nДля мого мозку різниці немає.",
    next: 'kai_pressure'
  },
  ...
  memory_flashback: {
    ...
    type: 'line',
    speaker: null,
    text: "Перед його останнім виходом. \nВін перевіряв кріплення скафандра. \nТоді він раптом сказав, не обертаючись.",
  ...
  el_final_thoughts: {
    ...
    type: 'line',
    speaker: null,
    text: "'Прометей' вже тут. \nВін відвезе мене назад до світу, \nде Кай — це архівні записи, \nфотографія у досьє та рядок у звіті 'загинув при виконанні'.\nА тут, за цим шлюзом... \nвін дихає. \nСИСТЕМА каже, що це ... \nвідзеркалення моїх бажань.",
  ...
  the_decision: {
    ...
    type: 'choice',
    choices: [
      { label: '«Я впускаю тебе. Відкрити шлюз.»', distortionDelta: +3, next: 'resolve_ending', tooltip: 'Прийняти його, незалежно від природи.' },
      { label: '«Пробач. Я не можу. Заблокувати шлюз.»', distortionDelta: -3, next: 'resolve_ending', tooltip: "Залишитися в об'єктивній реальності." },
  ...
  ending_ocean_2: {
    ...
    type: 'line',
    speaker: null,
    text: "Шлюз шипить. \Мені ніяково. \nВін зайшов...  \nБез скафандру. \nУ звичайній одежі, трохи м'ятій.  \nЙого руки — теплі та шорсткі.",
    next: 'ending_ocean_3'
  },
  ...
  ending_ocean_3: {
    ...
    type: 'line',
    speaker: "СИСТЕМА",
    text: "АКТИВІЗАЦІЯ ОКЕАНУ. ВИЯВЛЕНО НОВІ ФОРМИ: СПІРАЛЕВИДНІ СТРУКТУРИ.",
    next: 'ending_ocean_4'
  },
  ...
  ending_ocean_4: {
    ...
    type: 'line',
    speaker: null,
    text: "Ніби все навколо щойно зітхнуло з  полегшенням.\nВін обіймає мене. Я відчуваю його подих... Серцебиття... \nЦе реально... \nЦе має бути реально.",
    next: 'ending_ocean_5'
  },
  ...
  ending_ocean_5: {
    ...
    type: 'line',
    speaker: 'Я',
    text: "'Прометей' \nКОМАНДА: скасувати евакуацію.\nКа... Кай повернувся. Ситуація стабілізована. \nМи продовжимо дослідження океану. \nВін демонструє... нові паттерни взаємодії.\nЦе правильно. \nЦе... наш вибір.",
    next: 'ending_ocean_6'
  },
  ending_ocean_6: {
    id: 'ending_ocean_6',
    type: 'line',
    speaker: null,
    text: "Порожність станції поступово відступає. \nВін розповідає про те, що бачив 'там'. \nЯ слухаю, притулившись до нього.\nВін сміється. \nТоркається мого обличчя. \nГоворить, що любить мене. \nЦе він... \nЦе має бути він. \nБільше ніякої тиші.",
  ...
  ending_ocean_epilogue: {
    ...
    type: 'line',
    speaker: null,
    text: "'Прометей' відступив, не отримавши підтвердження.\nЯ вимикаю комунікатор. \nНехай думають, що станція загинула. \nНехай.",
  ...
  ending_ocean_epilogue_2: {
    ...
    type: 'line',
    speaker: null,
    text: "Іноді вночі, коли я прокидаюся, мені здається, що океан за вікном дивиться на нас. \nА Кай обіймає міцніше. \nІ я вірю йому. \n Бо це... мій вибір.",
    next: 'title_ocean'
  },
