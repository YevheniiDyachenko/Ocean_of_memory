...
const STORY_STEPS = {
  ...
  journal_entry_2: {
    ...
    lineCycleSuffix: { prefix: 'Це  ', words: ['мова?', 'музика?', 'гикавка космічної матерії? :)'] },
...
// --- ШЛЯХ ЕМОЦІЙ (Гравець довірився -> Кай тисне на провину) ---
 ...
 // --- СПІЛЬНИЙ ВИХІД ДЛЯ ШЛЯХІВ ЕМОЦІЙНОЇ ТА РАЦІОНАЛЬНОЇ ПЕРЕВІРКИ ---
  ...
  ai_warning_1: {
    ...
    type: 'line',
    speaker: 'СИСТЕМА',
    text: "ПОПЕРЕДЖЕННЯ: ДАНІ СУПЕРЕЧАТЬ ФІЗИЧНІЙ МОДЕЛІ. \nВІДСУТНЯ БІОМЕТРІЯ ОБ'ЄКТА. \nАНАЛІЗ ОБМЕЖЕНИЙ.",
    next: 'el_internal_2'
  },
  ...
  el_final_thoughts_3: {
    ...
    lineCycleSuffix: { prefix: '\nЦе ', words: ['та сама інформація.', 'ті самі патерни.', 'та сама любов. \nЯ лише обираю між самотністю та коханням.'] }, 
    next: 'the_decision'
  },
  ...
  resolve_ending: {
    id: 'resolve_ending',
    type: 'branch',
    nextByDistortion: { high: 'ending_ocean', low: 'ending_memory', high_alt: 'pre_ending_ocean', low_alt: 'pre_ending_memory', mid: 'ending_memory' }
  },
  // #endregion
  ...
  pre_ending_ocean: {
    ...
    type: 'line',
    speaker: 'Я',
    text: "... 99.8%.\nРозумію, що це ілюзія.\nАле це тепла ілюзія у світі холодної правди.",
  ...
  pre_ending_memory: {
    ...
    type: 'line',
    speaker: 'Я',
    text: "Палець завмер над кнопкою.\nЙого слова — пастка.\nЯ буду пам'ятати тебе, Каю... Завжди.",
  ...
  ending_ocean_2: {
    ...
    type: 'line',
    speaker: null,
    text: "Шлюз шипить. Він заходить... \nБез скафандра, у старому м'ятому одязі. Його руки теплі та шорсткі. \nВін справжній.",
